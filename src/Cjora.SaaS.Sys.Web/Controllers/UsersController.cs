...
public sealed class UsersController : ControllerBase
{
    ...
    [HttpGet]
    [AuthorizePermCode("sys:user:list")]
    ...
    [HttpGet("{id:long}")]
    [AuthorizePermCode("sys:user:detail")]
    ...
    [HttpPost]
    [AuthorizePermCode("sys:user:create")]
    ...
    [HttpPut("{id:long}")]
    [AuthorizePermCode("sys:user:update")]
    ...
    [HttpDelete("{id:long}")]
    [AuthorizePermCode("sys:user:delete")]
    ...
    [AuthorizePermCode("sys:user:role:list")]
    ...
    [AuthorizePermCode("sys:user:role:assign")]
    ...
    [AuthorizePermCode("sys:user:role:remove")]
