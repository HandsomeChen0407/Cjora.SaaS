...
public sealed class DepartmentsController : ControllerBase
{
    ...
    [HttpGet]
    [AuthorizePermCode("sys:department:list")]
    ...
    [HttpGet("tree")]
    [AuthorizePermCode("sys:department:tree")]
    ...
    [HttpGet("{id:long}")]
    [AuthorizePermCode("sys:department:detail")]
    ...
    [HttpPost]
    [AuthorizePermCode("sys:department:create")]
    ...
    [HttpPut("{id:long}")]
    [AuthorizePermCode("sys:department:update")]
    ...
    [HttpDelete("{id:long}")]
    [AuthorizePermCode("sys:department:delete")]
