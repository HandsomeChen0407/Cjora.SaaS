...
public sealed class PermissionsController : ControllerBase
{
    ...
    [HttpGet]
    [AuthorizePermCode("sys:permission:list")]
    ...
    [HttpGet("tree")]
    [AuthorizePermCode("sys:permission:tree")]
    ...
    [HttpGet("{id:long}")]
    [AuthorizePermCode("sys:permission:detail")]
    ...
    [HttpPost]
    [AuthorizePermCode("sys:permission:create")]
    ...
    [HttpPut("{id:long}")]
    [AuthorizePermCode("sys:permission:update")]
    ...
    [HttpDelete("{id:long}")]
    [AuthorizePermCode("sys:permission:delete")]
