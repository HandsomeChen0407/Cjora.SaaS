...
public interface IDataPermissionContext
{
    ...
    /// </summary>
    /// <remarks>
    /// 注意：默认仍保留租户级 <see cref="Cjora.SaaS.Core.Repository.ITenantScopedEntity"/> 全局过滤；
    /// 若需跨租户查询，请在单次查询上使用 <see cref="Cjora.SaaS.Core.SqlSugarInfrastructure.SqlSugarTenantQueryableExtensions.ClearTenantFilters{T}"/>。
    /// </remarks>
