...
/// <item><description>与 <see cref="Cjora.SaaS.Core.MultiTenancy.ITenantProvider"/> 配合：运行时租户来自 HTTP/后台任务上下文，写入实体的是「当前解析到的租户」，而不是客户端随意提交的值。</description></item>
/// </list>
/// </remarks>
public interface ITenantScopedEntity
{
    /// <summary>
    /// 租户标识，应与当前请求（或作业上下文）中 <see cref="Cjora.SaaS.Core.MultiTenancy.ITenantProvider.GetTenantId"/> 一致。
    /// </summary>
